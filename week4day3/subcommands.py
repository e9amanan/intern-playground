...
def main():
   ...
   #Create the Subparser Co
    ...
    val_parser.add_argument("--strict", action="store_true", help="Fail on minor warnings")
    ...
    trans_parser.add_argument("--batch-size", type=int, default=100, help="Rows per batch")
