import pytest
from week2day1.oopsfundamentals import Person, Task, UrgentTask, TaskManager
...
def test_person_full_name_setter_invalid():
    ...
    with pytest.raises(ValueError, match="must provide both a first name and a last name"):
