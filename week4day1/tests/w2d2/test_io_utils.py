...
from week2day2.insights_energy.io_utils import read_csv, write_csv, read_json, write_json
...
@patch("week2day2.insights_energy.io_utils.Path.is_file")
@patch("week2day2.insights_energy.io_utils.Path.exists")
@patch("builtins.open", new_callable=mock_open, read_data="timestamp,wrong_col\n2023-01-01,50.0")
